...
class OcclusionMap(object):
    ...
    def is_closed(self):
        if self.coords != None:
            ...
            # print("self.min_corner[0] = ", self.min_corner[0])
            # print("self.max_corner[0] = ", self.max_corner[0])
            ...
            #     return True
            # if norm(self.coords - point3(-20.18, -11.33, 0)) < 0.1 and self.min_corner[0] <= -0.1 and self.max_corner[0] >= 0.1:
            #     return True
