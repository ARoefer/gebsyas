...
from gebsyas.utils import StampedData, ros_msg_to_expr, cmdDictToJointState, Blank, vis_obj_to_expr
from iai_bullet_sim.srv import GetStaticGeometry
...
class BasicAgent(Agent):
    ...
    def awake(self, initial_action):
        ...
        try:
            ...
            res = srv_static_geom()
            print('Got {} objects from service call'.format(len(res.geometry)))
            for geom in res.geometry:
                obj = vis_obj_to_expr(geom)
